...
#include "third_party/libsodium/src/libsodium/crypto_ipcrypt/ipcrypt_soft.h"

#if defined(HAVE_ARMCRYPTO) && defined(NATIVE_LITTLE_ENDIAN)
#include "third_party/libsodium/src/libsodium/crypto_ipcrypt/ipcrypt_armcrypto.h"
#endif

#if defined(HAVE_AVXINTRIN_H) && defined(HAVE_WMMINTRIN_H)
#include "third_party/libsodium/src/libsodium/crypto_ipcrypt/ipcrypt_aesni.h"
#endif
